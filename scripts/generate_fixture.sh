...
echo "🔨 Compile Atria and Mock Server..."
...
trap "echo '🧹 Cleaning: Shut down Mock Server (PID $MOCK_PID)...'; kill $MOCK_PID; rm -f mock_info.json" EXIT
...
echo "================================================="
echo "🎉 Fixtures has been generated!"
